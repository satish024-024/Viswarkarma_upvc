    ...
    <div className="py-12 sm:py-16 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 space-y-16">
      ...
      <div className="space-y-3 max-w-2xl">
        ...
        <p className="text-sm text-brand-muted leading-relaxed">
          Ready to measure your window apertures or discuss framing profiles? Call our Peenya office or submit your message below to connect via WhatsApp.
        </p>
      </div>
              ...
              <form onSubmit={handleSubmit} className="space-y-4">
                ...
                <div>
                  ...
                  <textarea
                    ...
                    className="flex w-full rounded-lg border border-brand-border bg-white px-4 py-2.5 text-sm text-brand-foreground shadow-xs transition-all duration-200 focus:border-brand-secondary focus:ring-2 focus:ring-brand-accent focus:outline-none placeholder:text-brand-muted-light"
                  />
                </div>
          ...
          <Card className="border-brand-border bg-slate-50/50 p-6 sm:p-8 space-y-6">
            ...
            <ul className="space-y-4 text-xs">
              <li className="flex items-start gap-3">
                ...
                <div>
                  <span className="font-bold text-brand-primary block">Peenya Production Facility</span>
            ...
            <div className="border-t border-brand-border pt-6 flex items-start gap-2.5">
              ...
              <p className="text-[10px] text-brand-muted leading-relaxed">
                As a Peenya factory direct fabrication shop, we welcome builders, contractors, architects, and homeowners for scheduled walk-ins to inspect our profiles, reinforcement steels, and corner weld equipment.
              </p>
            </div>
          </Card>
        </div>
